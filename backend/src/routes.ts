...
router.get('/widget/products', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const defaultProds = [
      { id: "101", partnerId: "PART-101", nome: "Snowland Passaporte Adulto", preco: 169.00, categoria: "PWI", descricao: "Acesso integral à montanha de neve, aluguel de roupas de frio e patinação no gelo.", imgUrl: "https://images.unsplash.com/photo-1486915309851-b0cc1f8a0084?auto=format&fit=crop&w=500&q=80" },
      { id: "102", partnerId: "PART-101", nome: "Acqua Motion Pass", preco: 149.00, categoria: "PWI", descricao: "Acesso ao único parque aquático coberto e climatizado com águas termais da América do Sul.", imgUrl: "https://images.unsplash.com/photo-1605810230434-7631ac76ec81?auto=format&fit=crop&w=500&q=80" },
